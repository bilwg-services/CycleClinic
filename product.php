            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">With All Product Data</p>
                  <a href="category.php" style="color: #fff; float:right; margin-top: -40px; margin-right: 120px;">Manage Categories</a>
                  <a href="addproduct.php" style="color: #fff; float:right; margin-top: -40px; margin-right: 20px;">Add Products</a>
                </div>
                <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM `addons` LIMIT $page_start,$page_end ";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo "<tr>
                            <td colspan='10'><center>No Products Found </center></td>
                            </tr>";
                        }
                        ?>
