                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                    ...
                                    if ($id == "")
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                $insurence = ($row[12] == 1) ? "Yes" : "No";
                                                $newbike = ($row[13] == 1) ? "Yes" : "No";
                                                if ($row[10] == 5) {
                                ...
                                <br>
                                <h4><b>Type:</b> $row[5]</h4>
                                <p><b>Service:</b> $row[6]</p>
                                <p><b>Address:</b> $row[7]</p>
                                <p><b>Remark: </b>$row[8]</p>
                                <p><b>Day: </b>$row[19] | <b>City</b>$row[20]</p>
                                <p>Addon: </p>";
                                $addonid = substr($row[10],1);
